...
function GUI:Init()
    ...
    do
        ...
        do
            ...
            s:SetHeight(14)
            s:SetWidth(160)
            s:SetMinMaxValues(500, 50000)
            s:SetValueStep(500)
            s:SetObeyStepOnDrag(true)
            s.Low:SetText(GOLD_AMOUNT_TEXTURE_STRING:format(500))
            s.High:SetText(GOLD_AMOUNT_TEXTURE_STRING:format(50000))
        ...
        do
            ...
            do
                ...
                do
                    ...
                    s:SetHeight(14)
                    s:SetWidth(160)
                    s:SetMinMaxValues(100, 5000)
                    s:SetValueStep(100)
                    s:SetObeyStepOnDrag(true)
                    s.Low:SetText(GOLD_AMOUNT_TEXTURE_STRING:format(100))
